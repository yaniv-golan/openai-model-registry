...
class TestSchemaVersionValidator:
    ...
    def test_get_schema_version_missing_uses_default(self):
    ...
    def test_is_compatible_schema_invalid_versions(self):
    ...
    def test_is_compatible_schema_malformed(self):
    ...
    def test_get_compatible_range_valid(self):
    ...
    def test_get_compatible_range_invalid(self):
    ...
    def test_validate_schema_structure_valid_1x(self):
        """Test structure validation for valid 1.x schema."""
        config_data = {"version": "1.0.0", "models": {}}
        assert SchemaVersionValidator.validate_schema_structure(config_data, "1.0.0") is True

    def test_validate_schema_structure_missing_version(self):
    ...
    def test_validate_schema_structure_missing_models(self):
    ...
    def test_validate_schema_structure_unsupported_version(self):
        """Test structure validation fails for unsupported versions."""
        config_data = {"version": "2.0.0", "models": {}}
        assert SchemaVersionValidator.validate_schema_structure(config_data, "2.0.0") is False

    def test_validate_schema_structure_malformed_version(self):
    ...
    def test_get_loader_method_name_valid_1x(self):
    ...
    def test_get_loader_method_name_unsupported(self):
    ...
    def test_get_loader_method_name_malformed(self):
    ...
    def test_supported_schema_versions_constant(self):
        """Test that supported schema versions constant is properly defined."""
        versions = SchemaVersionValidator.SUPPORTED_SCHEMA_VERSIONS
...
class TestSchemaVersionEdgeCases:
    ...
    def test_semver_import_error_handling(self):
    ...
    def test_version_with_leading_v(self):
        ...
        config_data = {"version": "v1.0.0", "models": {}}
    ...
    def test_extremely_long_version(self):
        ...
        long_version = "1.0.0-" + "a" * 1000
        config_data = {"version": long_version, "models": {}}
    ...
    def test_unicode_version(self):
        ...
        config_data = {"version": "1.0.0-αβγ", "models": {}}
        with pytest.raises(ValueError):
            SchemaVersionValidator.get_schema_version(config_data)

    def test_numeric_version_object(self):
        """Test handling of numeric version objects."""
        config_data = {"version": {"major": 1, "minor": 0, "patch": 0}, "models": {}}
